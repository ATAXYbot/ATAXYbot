                    ...
                    if (generatedTestResult) {
                        if (showScoreSummary) {
                            ...
                            const handleGenerateTargetedDPP = (subjectName, chapterName, topicNamesArray, count) => {
                                ...
                                if (subData) {
                                    ...
                                    if (chapData) {
                                        chapData.topics?.forEach(t => {
                                            if (topicNamesArray.includes(t.name)) {
                                ...
                                const testTitleName = topicNamesArray.length === 1 ? topicNamesArray[0] : chapterName + ' (Weak Topics)';
                                const newTest = {
                                    id: 'test_' + Date.now(),
                                    type: 'dpp',
                                ...
                                safeAlert(`Targeted DPP (${testQuestions.length} Qs) Generated Successfully! Check your saved tests.`);
                            };
                                                                ...
                                                                <div className="flex items-center gap-2 shrink-0">
                                                                    {(chap.incorrect > 0 || chap.unattempted > 0) && (
                                                                        <button onClick={(e) => { 
                                                                            ...
                                                                            <i className="fa-solid fa-bullseye mr-1"></i> Auto-DPP
                                                                        </button>
                                                                    )}
                                                                        ...
                                                                        <div key={j} className="flex justify-between items-center bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm">
                                                                            ...
                                                                            <div className="flex gap-1 shrink-0 items-center">
                                                                                {(top.incorrect > 0 || top.unattempted > 0) && (
                                                                                    <button onClick={(e) => { e.preventDefault(); handleGenerateTargetedDPP(chap.subject, chap.name, [top.name], 10); }} className="px-2 h-4 mr-1 flex items-center justify-center bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-sm text-[9px] font-bold shadow-[0_1px_2px_rgba(0,0,0,0.1)] transition-colors active:scale-95" title="Auto-Generate DPP"><i className="fa-solid fa-bullseye mr-1"></i> Auto-DPP</button>
                                                                                )}
