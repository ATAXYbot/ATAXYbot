...
const startStr = 'const renderAnalyticsModal = () => {';
const endStr = '// --- PROFILE & PERFORMANCE ---';
...
const dynamicModal = `
            const renderAnalyticsModal = () => {
                ...
                return ReactDOM.createPortal(
                    <div className="fixed inset-0 pt-[max(env(safe-area-inset-top),_16px)] z-[200000] bg-gray-50/95 dark:bg-black/95 backdrop-blur-md flex flex-col animate-slide-up overflow-hidden w-full mx-auto">
                        {/* HEADER */}
...
code = code.slice(0, start) + dynamicModal + code.slice(end);
fs.writeFileSync('index.html', code);
console.log('Fixed renderAnalyticsModal fully and completely.');
